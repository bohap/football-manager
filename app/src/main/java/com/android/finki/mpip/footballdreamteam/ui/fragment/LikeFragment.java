...
public class LikeFragment extends BaseFragment implements LikeView {
    ...
    /**
     * Called when a request has been send to add a like to the lineup.
     */
    @Override
    ...
    /**
     * Called when a request has been send to remove the lineup like.
     */
    @Override
