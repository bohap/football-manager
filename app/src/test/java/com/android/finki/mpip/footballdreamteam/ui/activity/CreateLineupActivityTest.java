...
public class CreateLineupActivityTest {
    ...
    /**
     * Test the behavior when showStoringSuccess is called.
     */
    @Test
    public void testShowStringSuccess() {
        final Lineup lineup = new Lineup(1, 1);
        activity.showStoringSuccessful(lineup);
        Intent expectedIntent = new Intent(activity, LineupDetailsActivity.class);
        expectedIntent.putExtra(LineupDetailsActivity.LINEUP_ID_BUNDLE_KEY, lineup.getId());
